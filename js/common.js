...
$(".input-phone").mask("+7 (999) 999-99-99");
	...
	$(".button-more .btn-page").click(function(e) {
		e.preventDefault();
		$(this).parent().siblings(".text-more").toggleClass("active")
		if ($(this).parent().siblings(".text-more").hasClass("active")) {
			$(this).html("Свернуть");
		} else {
